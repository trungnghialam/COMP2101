...
#unpack tar file and remove it if we successful
test -f ~/Pictures/pics.tgz && tar -xvf pics.tgz -C ~/Pictures  && rm ~/Pictures/pics.tgz

######################
#sumarizes and report on what we have in the picture directory
